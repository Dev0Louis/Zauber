...
public class ZauberItems {
    ...
    public static final Item RITUAL_STONE =
            registerCreativeTab("ritual_stone", new BlockItem(ZauberBlocks.RITUAL_STONE, new Item.Settings().rarity(Rarity.RARE)));
    public static final Item ITEM_SACRIFICER =
            registerCreativeTab("item_sacrificer", new BlockItem(ZauberBlocks.ITEM_SACRIFICER, new Item.Settings().rarity(Rarity.RARE)));
    public static final Item DARKNESS_ACCUMULATOR =
            registerCreativeTab("darkness_accumulator", new BlockItem(ZauberBlocks.DARKNESS_ACCUMULATOR, new Item.Settings().rarity(Rarity.RARE)));
