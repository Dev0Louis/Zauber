...
public class HeartOfTheIceRitual extends Ritual {
    ...
    public HeartOfTheIceRitual(World world, RitualStoneBlockEntity ritualStoneBlockEntity) {
    ...
    public void finish() {
        if (this.ice >= 4) {
            ...
            this.ritualStoneBlockEntity.setStoredStack(ZauberItems.HEART_OF_THE_ICE.getDefaultStack());
        }
    }
