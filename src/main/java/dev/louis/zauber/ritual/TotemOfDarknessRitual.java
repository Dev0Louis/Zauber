...
public class TotemOfDarknessRitual extends Ritual {
    ...
    public TotemOfDarknessRitual(World world, RitualStoneBlockEntity ritualStoneBlockEntity, List<BlockPos> darknessAccumulators) {
    ...
    public void finish() {
        ...
        if (this.ritualStoneBlockEntity.getStoredStack().isOf(Items.TOTEM_OF_UNDYING) && collectedDarkness >= 4) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX() + 0.5, pos.getY() + 1, pos.getZ() + 0.5, ZauberItems.TOTEM_OF_DARKNESS.getDefaultStack(), 0, 0.3f, 0));
        } else {
